...
class file extends control
{
    ...
    public function download($fileID, $mouse = '')
    {
        ...
        if($mode == 'open')
        {
            ...
            echo js::alert($this->lang->file->NotExists);
        ...
        else
        {
            ...
            if(file_exists($file->realPath))
            {
                ...
                $this->sendDownHeader($fileName, $file->extension, $fileData, $file->downloads, $file->id);           
     ...
     * @return void
     */
    public function export2XLS($fields = '', $rows = '')
    {
        $this->view->fields = $fields;
        $this->view->rows   = $rows;
        $output = $this->parse('file', 'export2XLS');
        ...
        $this->sendDownHeader(date("Y-m-d"), 'xls', $output);
    }
     ...
     * @return void
     */
    public function sendDownHeader($fileName, $fileType, $content, $downloads = 0, $id = 0)
    {
        ...
        $this->file->updateDownloads($downloads,$id);
        die($content);
    }
