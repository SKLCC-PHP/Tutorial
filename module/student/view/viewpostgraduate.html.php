      ...
      <td class='w-120px'>
        <div class='btn-group'>
          <?php
            ...
            echo html::linkButton($lang->goback, $this->inlink('viewPostgraduate'));
          ?>
        </div>
      </td>
    </tr>
...
<br/>
<div id = 'main'>
  <table class='table table-condensed table-hover table-striped tablesorter' align = 'center' id='postgraduateList'>
