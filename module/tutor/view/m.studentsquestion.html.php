...
<?php if ($breakPromNum == 5):?>
    <div class="pull-right"><?php common::printLink('tutor', 'viewMoreProblem', "student_account=$student_account", $lang->more . "&nbsp;<i class='icon-th icon icon-double-angle-right'></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");?></div>
<?php endif;?>
<?php endif;?>
</div>
