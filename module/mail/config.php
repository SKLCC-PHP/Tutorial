...
$config->mail->turnon = false;				// true or false
...
$config->mail->provider['suda.edu.cn']['host']       = 'smtp.suda.edu.cn';
$config->mail->provider['suda.edu.cn']['secure']     = 'ssl';
$config->mail->provider['suda.edu.cn']['port']       = '25';