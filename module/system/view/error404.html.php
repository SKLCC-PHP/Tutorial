...
<style type="text/css">
  html, body, div, span,   iframe, p,   a,    img,   q, s, samp, small, strike,strong,sub,sup,tt,var,b,u,i,dl,dt,dd,ol,ul,li,form,label,table,tbody,thead, tr, th, td,embed {
  margin: 0;
  padding: 0;
  border: 0;
  font-size: 100%;
...
<body>
    ...
    <div id="content">
      ...
      <div class="utilities" align="center">
        <?php
          $link = $this->createLink('my', 'index');
          $label = '返回首页';
          echo " <a type='button' href='#' onclick='self.location=\"$link\"' class='button'>$label</a>";
        ?>
        <div class="clear"></div>
      </div>
    </div>
<!--     <div id="footer">
      <ul>
        <li><?php echo html::a($this->createLink('my', 'index'),  '首页');?></li>
      </ul>
    </div> -->
  </div>
</div>
