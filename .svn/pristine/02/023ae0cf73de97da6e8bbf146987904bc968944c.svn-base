...
<div class='main'>
  ...
  <input type='hidden' value='viewAllStudent', name='method'/>
        ...
        <td class='w-120px'>
          <div class='btn-group'>
            <?php
              ...
              echo html::linkButton($lang->goback, $this->inlink('viewAllStudent'));
            ?>
          </div>
        </td>
      </tr>
    ...
    <?php $vars = "paramname=$searchname&paramaccount=$searchaccount&orderBy=%s&recTotal=$recTotal&recPerPage=$recPerPage&pageID=$pageID"; ?>
      ...
      <?php foreach ($students as $student):?>
      	<tr class = 'text-center'>
      	  ...
      	  <td><?php foreach ($student->tutor as $value) echo $value . '&nbsp&nbsp&nbsp&nbsp';?></td>
      	</tr>
      <?php endforeach;?>
      </tbody>
      <tfoot>
