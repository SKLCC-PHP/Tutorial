...
<div id='titlebar'>
  <div class='heading'>
    <strong><?php echo $lang->resources->viewMoreAchievement . '&nbsp&nbsp&nbsp' . $userpairs[$teacher_account];?></strong>
  </div>
  <div class='actions'>
  ...
  <?php $vars = "teacher_account=$teacher_account&orderBy=%s&recTotal=$recTotal&recPerPage=$recPerPage&pageID=$pageID"; ?>
    <thead>
      <tr class='text-center'>
        ...
        <th class='w-hour'><?php common::printOrderLink('teaID', $orderBy, $vars, $lang->achievement->creator);?></th>
